...
class tutor_nelc_integration_Settings {
	...
	public function settings_assets() {
		...
		wp_register_script( $this->parent->_token . '-settings-js', $this->parent->assets_url . 'js/settings' . $this->parent->script_suffix . '.js', array( 'farbtastic', 'jquery' ), '3.0.9', true );
	...
	public function settings_page() {
		...
		// تذييل احترافي مع أرقام الدعم وروابط واتساب
